...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_image_text_section" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_image_text_section" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_image_text_section" ADD CONSTRAINT "pages_blocks_image_text_section_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_image_text_section" ADD CONSTRAINT "_pages_v_blocks_image_text_section_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_image_text_section_order_idx" ON "pages_blocks_image_text_section" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_image_text_section_parent_id_idx" ON "pages_blocks_image_text_section" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_image_text_section_path_idx" ON "pages_blocks_image_text_section" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "pages_blocks_image_text_section_media_idx" ON "pages_blocks_image_text_section" USING btree ("media_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_image_text_section_order_idx" ON "_pages_v_blocks_image_text_section" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_image_text_section_parent_id_idx" ON "_pages_v_blocks_image_text_section" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_image_text_section_path_idx" ON "_pages_v_blocks_image_text_section" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_image_text_section_media_idx" ON "_pages_v_blocks_image_text_section" USING btree ("media_id");
