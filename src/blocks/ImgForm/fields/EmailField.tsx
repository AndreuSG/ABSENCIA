...
export const EmailField = ({ field, iconName, errorClass }: any) => (
  <div className="mb-8 text-left w-full relative">
    <input
      name={field.name}
      type="email"
      className={`w-full text-gray-500 text-xl border-0 border-b-2 transition-colors duration-300 ${errorClass} outline-none px-3 py-2 bg-transparent`}
