...
export const CountryField = ({ field, options, iconName, errorClass }: any) => (
  <div className="mb-4 w-full relative">
    <select
      name={field.name}
      className={`w-full border-0 border-b-2 transition-colors duration-300 ${errorClass} outline-none px-3 py-2 bg-transparent text-gray-500 appearance-none`}
      defaultValue=""
    >
